...
def sample_availability():
    ...
    return Availability(
        weekday_evenings="after 18:00",
        weekend_mornings="09:00-12:00"
    )
...
@pytest.fixture
def sample_lifestyle_and_rhythms(sample_availability, sample_mobility, sample_environmental_context):
        ...
        default_data = {
            ...
            "lifestyle_and_rhythms": LifestyleAndRhythms(
                availability=Availability(
                    weekday_evenings="Flexible",
                    weekend_mornings="Flexible"
                ),
...
def pytest_configure(config):
    ...
    config.addinivalue_line(
        "markers", "api: API endpoint tests (requires FastAPI)"
    )
    config.addinivalue_line(
